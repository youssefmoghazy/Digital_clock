...
{
	DIO_u8_DDRA_REG = Conc(DIO_u8_PA7_INTIAL_DIRECTIONS,DIO_u8_PA6_INTIAL_DIRECTIONS,DIO_u8_PA5_INTIAL_DIRECTIONS,DIO_u8_PA4_INTIAL_DIRECTIONS,
						   DIO_u8_PA3_INTIAL_DIRECTIONS,DIO_u8_PA2_INTIAL_DIRECTIONS,DIO_u8_PA1_INTIAL_DIRECTIONS,DIO_u8_PA0_INTIAL_DIRECTIONS);
							
	DIO_u8_DDRB_REG = Conc(DIO_u8_PB7_INTIAL_DIRECTIONS,DIO_u8_PB6_INTIAL_DIRECTIONS,DIO_u8_PB5_INTIAL_DIRECTIONS,DIO_u8_PB4_INTIAL_DIRECTIONS,
							DIO_u8_PB3_INTIAL_DIRECTIONS,DIO_u8_PB2_INTIAL_DIRECTIONS,DIO_u8_PB1_INTIAL_DIRECTIONS,DIO_u8_PB0_INTIAL_DIRECTIONS);
							
	DIO_u8_DDRC_REG = Conc(DIO_u8_PC7_INTIAL_DIRECTIONS,DIO_u8_PC6_INTIAL_DIRECTIONS,DIO_u8_PC5_INTIAL_DIRECTIONS,DIO_u8_PC4_INTIAL_DIRECTIONS,
						   DIO_u8_PC3_INTIAL_DIRECTIONS,DIO_u8_PC2_INTIAL_DIRECTIONS,DIO_u8_PC1_INTIAL_DIRECTIONS,DIO_u8_PC0_INTIAL_DIRECTIONS);
							
	DIO_u8_DDRD_REG = Conc(DIO_u8_PD7_INTIAL_DIRECTIONS,DIO_u8_PD6_INTIAL_DIRECTIONS,DIO_u8_PD5_INTIAL_DIRECTIONS,DIO_u8_PD4_INTIAL_DIRECTIONS,
						   DIO_u8_PD3_INTIAL_DIRECTIONS,DIO_u8_PD2_INTIAL_DIRECTIONS,DIO_u8_PD1_INTIAL_DIRECTIONS,DIO_u8_PD0_INTIAL_DIRECTIONS);
...
u8 DIO_u8GetPinValue      (u8 Copy_u8PortId , u8 Copy_u8PinId , u8 * Copy_pu8ReturnPinValue)
{
	...
	if((Copy_u8PinId<=  DIO_u8_PIN7)&&(Copy_u8PortId<=DIO_u8_PORTD)&&(Copy_pu8ReturnPinValue != NULL))
	{
		switch(Copy_u8PortId)
		{
			case DIO_u8_PORTA : 
			Local_u8_PinValue = GET_BIT(DIO_u8_PINA_REG,Copy_u8PinId);
			if(Local_u8_PinValue == DIO_u8_LOW )
			{
			...
			case DIO_u8_PORTB : 
			Local_u8_PinValue = GET_BIT(DIO_u8_PINB_REG,Copy_u8PinId);
			if(Local_u8_PinValue == DIO_u8_LOW )
			{
				*Copy_pu8ReturnPinValue =DIO_u8_LOW;
			}
			...
			case DIO_u8_PORTC : 
			Local_u8_PinValue = GET_BIT(DIO_u8_PINC_REG,Copy_u8PinId);
			if(Local_u8_PinValue == DIO_u8_LOW )
			{
				*Copy_pu8ReturnPinValue =DIO_u8_LOW;
			}
			...
			case DIO_u8_PORTD : 
			Local_u8_PinValue = GET_BIT(DIO_u8_PIND_REG,Copy_u8PinId);
			if(Local_u8_PinValue == DIO_u8_LOW )
			{
				*Copy_pu8ReturnPinValue =DIO_u8_LOW;
			}
...
{
	u8 Local_u8ErrorState= STD_TYPES_OK;
	if(Copy_pu8ReturnPortValue != NULL)
	{
		switch(Copy_u8PortId)
		{
